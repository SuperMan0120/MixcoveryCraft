...
public class BuchersSmiteMechanicProcedure {
	@SubscribeEvent
	...
	private static void execute(@Nullable Event event, Entity entity, Entity sourceentity) {
		...
		if (entity instanceof Monster
				...
				&& EnchantmentHelper.getItemEnchantmentLevel(MixcoverycraftModEnchantments.BUCHERS_SMITE,
						(sourceentity instanceof LivingEntity _livEnt ? _livEnt.getMainHandItem() : ItemStack.EMPTY)) > 0) {
			entity.hurt(DamageSource.GENERIC, EnchantmentHelper.getItemEnchantmentLevel(MixcoverycraftModEnchantments.BUCHERS_SMITE,
					(sourceentity instanceof LivingEntity _livEnt ? _livEnt.getMainHandItem() : ItemStack.EMPTY)));
		}
		if (!(entity instanceof Monster)
				&& ((sourceentity instanceof LivingEntity _livEnt ? _livEnt.getMainHandItem() : ItemStack.EMPTY)
