...
public class TitaniumOreFeature extends OreFeature {
	public static final TitaniumOreFeature FEATURE = (TitaniumOreFeature) new TitaniumOreFeature().setRegistryName("mixcoverycraft:titanium_ore");
	public static final ConfiguredFeature<?, ?> CONFIGURED_FEATURE = FEATURE
			.configured(new OreConfiguration(TitaniumOreFeatureRuleTest.INSTANCE, MixcoverycraftModBlocks.TITANIUM_ORE.defaultBlockState(), 4))
			.range(new RangeDecoratorConfiguration(UniformHeight.of(VerticalAnchor.absolute(1), VerticalAnchor.absolute(30)))).squared().count(7);
	...
	private static class TitaniumOreFeatureRuleTest extends RuleTest {
		...
		static final RuleTestType<TitaniumOreFeatureRuleTest> CUSTOM_MATCH = Registry.register(Registry.RULE_TEST,
				new ResourceLocation("mixcoverycraft:titanium_ore_match"), () -> codec);
