...
public class TinOreFeature extends OreFeature {
	public static final TinOreFeature FEATURE = (TinOreFeature) new TinOreFeature().setRegistryName("mixcoverycraft:tin_ore");
	public static final ConfiguredFeature<?, ?> CONFIGURED_FEATURE = FEATURE
			.configured(new OreConfiguration(TinOreFeatureRuleTest.INSTANCE, MixcoverycraftModBlocks.TIN_ORE.defaultBlockState(), 13))
	...
	private static class TinOreFeatureRuleTest extends RuleTest {
		...
		static final RuleTestType<TinOreFeatureRuleTest> CUSTOM_MATCH = Registry.register(Registry.RULE_TEST,
				new ResourceLocation("mixcoverycraft:tin_ore_match"), () -> codec);
