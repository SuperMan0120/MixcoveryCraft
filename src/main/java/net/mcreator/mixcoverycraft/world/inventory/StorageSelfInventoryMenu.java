...
package net.mcreator.mixcoverycraft.world.inventory;
...
import net.mcreator.mixcoverycraft.init.MixcoverycraftModMenus;

import java.util.function.Supplier;
import java.util.Map;
import java.util.HashMap;

public class StorageSelfInventoryMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public StorageSelfInventoryMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(MixcoverycraftModMenus.STORAGE_SELF_INVENTORY, id);
		...
		this.customSlots.put(4, this.addSlot(new SlotItemHandler(internal, 4, 97, 26) {
		}));
		this.customSlots.put(5, this.addSlot(new SlotItemHandler(internal, 5, 115, 26) {
		}));
		...
		this.customSlots.put(10, this.addSlot(new SlotItemHandler(internal, 10, 97, 44) {
		}));
