...
public class FishDnaItem extends Item {
	...
	public InteractionResultHolder<ItemStack> use(Level world, Player entity, InteractionHand hand) {
		...
		FishDnaRightClickedInAirProcedure.execute(entity);
		return ar;
	}
}
