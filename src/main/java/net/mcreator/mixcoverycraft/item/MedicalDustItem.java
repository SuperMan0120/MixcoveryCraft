...
import net.mcreator.mixcoverycraft.procedures.MedicalDustFoodEatenProcedure;
import net.mcreator.mixcoverycraft.init.MixcoverycraftModTabs;

public class MedicalDustItem extends Item {
	public MedicalDustItem() {
	...
	public ItemStack finishUsingItem(ItemStack itemstack, Level world, LivingEntity entity) {
		...
		MedicalDustFoodEatenProcedure.execute(entity);
		return retval;
	}
}
