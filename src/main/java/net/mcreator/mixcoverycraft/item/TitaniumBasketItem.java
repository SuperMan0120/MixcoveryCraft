...
import net.mcreator.mixcoverycraft.item.inventory.TitaniumBasketInventoryCapability;
...
public class TitaniumBasketItem extends Item {
	public TitaniumBasketItem() {
		super(new Item.Properties().tab(MixcoverycraftModTabs.TAB_MIXCOVERY_CRAFT_ITEMS).stacksTo(1).rarity(Rarity.COMMON));
		setRegistryName("titanium_basket");
	}
		...
		if (entity instanceof ServerPlayer serverPlayer) {
			NetworkHooks.openGui(serverPlayer, new MenuProvider() {
				...
				public Component getDisplayName() {
					return new TextComponent("Titanium Basket");
				}
	...
	public ICapabilityProvider initCapabilities(ItemStack stack, @Nullable CompoundTag compound) {
		return new TitaniumBasketInventoryCapability();
	}
