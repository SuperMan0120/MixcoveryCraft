...
public class BatDnaItem extends Item {
	...
	public InteractionResultHolder<ItemStack> use(Level world, Player entity, InteractionHand hand) {
		...
		BatDnaRightClickedInAirProcedure.execute(entity);
		return ar;
	}
}
